                <footer class="footer">
                    <div class="w-100 clearfix">
                        ...
                        <span class="float-none float-sm-right mt-1 mt-sm-0 text-center">Crafted with <i class="fa fa-heart text-danger"></i> by <a href="http://webhunter24.com/" class="text-dark" target="_blank">webhunter24.com</a></span>
                    </div>
                </footer>
